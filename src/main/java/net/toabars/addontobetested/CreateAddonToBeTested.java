...
public class CreateAddonToBeTested
{
    ...
    public CreateAddonToBeTested(IEventBus modEventBus, ModContainer modContainer)
    {
        ...
        // Note that this is necessary if and only if we want *this* class (CreateAddontobetested) to respond directly to events.
